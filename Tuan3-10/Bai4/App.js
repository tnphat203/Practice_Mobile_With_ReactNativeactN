import { Text, TouchableOpacity, Image, View, TextInput, FlatList } from 'react-native';
...
const xeProps = { id: Int16Array, name: String, price: Float32Array, description: String, discount: Int16Array, image: Image }
    ...
    return (
        <View style={{
            ...
            <TouchableOpacity onPress={() => navigation.navigate('ChiTiet')}>
                <Image source={xeProps.image} style={{
                    height: 120,
                    width: 110,
                }} />
                <Text style={{
                ...
                <Text style={{
                    fontSize: 20,
                }}>{xeProps.price}</Text></TouchableOpacity>
